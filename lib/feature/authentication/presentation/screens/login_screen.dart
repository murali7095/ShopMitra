    ...
    return Container(
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          ...
          body: authState.isLoading ? Center(child: CircularProgressIndicator(),): SingleChildScrollView(
            child: Padding(
                      ...
                      onPressed: () {
                        if (_formKey.currentState?.validate() ?? false) {
                          if (passwordError == null &&
                            ...
                            ref.read(loginModelProvider.notifier).state=loginModel;
